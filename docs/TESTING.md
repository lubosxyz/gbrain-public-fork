...
- `test/search-output-redaction.test.ts` — credential-like output scrubbing across nested search-result fields, CLI formatting, MCP operation returns, and non-mutating copies.
